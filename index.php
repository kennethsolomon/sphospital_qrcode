...
<?php    
     ...
     */
        ...
        //echo '<form action="index.php" method="post">
            //Patient Number:&nbsp;<input name="data" value="'.(isset($_REQUEST['data'])?htmlspecialchars($_REQUEST['data']):'QR CODE HERE').'" />&nbsp;
            ...
            //
        echo '<form class="no-print" action="index.php" method="post">
            Patient Number:&nbsp;<input name="data" value="'.(isset($_REQUEST['data'])?htmlspecialchars($_REQUEST['data']):'QR CODE HERE').'" />&nbsp;
            ECC:&nbsp;<select name="level">
                <option value="H"'.(($errorCorrectionLevel=='H')?' selected':'').'>H - best</option>
            </select>&nbsp;
